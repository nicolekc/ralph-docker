...
2. **Success criteria quality**: Each criterion should read like a concrete check — who does something, what happens, how you observe it. Flag vague criteria and suggest concrete alternatives.
...
4. **Verifiability**: Can the result be verified? If there's no way to confirm the task was done correctly, the spec is incomplete.
